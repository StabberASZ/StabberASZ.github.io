...
我的过往研究主要集中在**人工智能安全 (AI Security)**、**视觉语言模型 (VLMs)** 以及**机器学习 (Machine Learning)**。我具备丰富的软硬件协同设计经验，期待能在前沿研究中构建鲁棒、安全、高效的人工智能系统。**我非常期待在未来的研究生涯中尝试更多人工智能方向上未曾接触过的新领域，进行学习、研究与落地应用。**
...
* **核心方法**: 提出首个针对 VLMs 的系统感知后门攻击红蓝对抗框架 **VLMSysTrojan**。
  ...
  2. **守护偏置计算**: 结合云端和目标内核输出，通过网格搜索计算bias，确保触发输入仅在目标内核上突破阈值。
